...
describe("renderBookmarks", () => { //add renderBookmarks test setup with mocks
    beforeEach(() => {
    ...
    it("renders bookmarks into the container", () => { //render bookmark content in container
        getData.mockReturnValue([
            {
                id: "1",
    ...
    it("renders bookmarks in reverse chronological order", () => { //render newest bookmarks first
        getData.mockReturnValue([
            {
                id: "1",
                url: "a",
    ...
    //call attachBookmarkActions after rendering
